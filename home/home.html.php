...
<?php include 'includes/nav-home.inc.html.php'; ?>
    ...
    <main>
        ...
        <section class="darkSection">
            <h2>Athlete and Volunteer Testimonials</h2>
...
<?php include 'includes/footer-home.inc.html.php'; ?>